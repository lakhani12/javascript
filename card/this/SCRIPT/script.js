...
// create a object that have data and functions
function save (obj) {
...
const UserManagement = {
    ...
    renderUi: function () {
        ...
        console.log(drole, dbio)
        console.log(users_cards);

        /**
 * save a user object in `localStorage`
 * @param {Object} user – any serialisable data (e.g. {id:123,name:'Alice'})
 */
